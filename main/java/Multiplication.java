...
public class Multiplication {
    ...
    public static class multiplicationMapper extends Mapper<LongWritable, Text, Text,DoubleWritable>{
        ...
        protected void setup(Context context) throws IOException {
            ...
            while (line != null){
                ...
                String[] movies = tokens.toString().trim().split(":");
                ...
                if (movieRelationMap.get(movie1).add(movieRelation)){
    ...
    public class MultiplicationReduser extends Reducer<Text, DoubleWritable, IntWritable, Text> {
    ...
    public static void main(String[] args) throws Exception{
        ...
        job.setReducerClass(MultiplicationReduser.class);
